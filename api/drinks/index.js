...
module.exports = async function (context, req) {
  context.log('Drink entries function called');
  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      const { date, time, drink, amount, notes } = req.body;
    ...
    context.log.error('Error in drink function:', error);
    context.res = {
      status: 500,
      headers: { 'Content-Type': 'application/json' },
